...
CASSANDRA_TEST_SUPPORT_DS_LICENSE=${CASSANDRA_TEST_SUPPORT_DS_LICENSE:-DS_LICENSE}
CASSANDRA_TEST_SUPPORT_DS_LICENSE_VALUE=${CASSANDRA_TEST_SUPPORT_DS_LICENSE_VALUE:-accept}
...
# Add environment variable to support datastax driver
CMD="docker run --name $CASSANDRA_TEST_SUPPORT_CONTAINER -e $CASSANDRA_TEST_SUPPORT_DS_LICENSE=$CASSANDRA_TEST_SUPPORT_DS_LICENSE_VALUE -p $CASSANDRA_TEST_SUPPORT_PORT:$CASSANDRA_TEST_SUPPORT_CONTAINER_PORT -d $CASSANDRA_TEST_SUPPORT_CONTAINER_IMAGE:$CASSANDRA_TEST_SUPPORT_TAG"
echo "$CMD"
$CMD
